...
public class Tracer {
	...
	public static Set<Trace> getTraces(Process process, ReachabilityGraph rg)
			throws Exception {
		...
		return getTraces(process, rg, start, end, new Trace(),
				new HashSet<Edge>());
	}

	private static Set<Trace> getTraces(Process process,
