 ...
 * 
 */
@WebServiceClient(name = "HelloService", targetNamespace = "http://jaxws.examples.jf.ls14.cs.udo.edu/", wsdlLocation = "http://localhost:8080/emf-ws-example/HelloService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOSERVICE_QNAME = new QName("http://jaxws.examples.jf.ls14.cs.udo.edu/", "HelloService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/emf-ws-example/HelloService?wsdl");
    ...
    public Hello getHelloPort() {
        return super.getPort(new QName("http://jaxws.examples.jf.ls14.cs.udo.edu/", "HelloPort"), Hello.class);
    }
    ...
    public Hello getHelloPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://jaxws.examples.jf.ls14.cs.udo.edu/", "HelloPort"), Hello.class, features);
    }
