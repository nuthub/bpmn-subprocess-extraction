...
public class FragmentUtil {
	...
	public static boolean contains(Fragment fragment1, Fragment fragment2) {
		return getContainedFlowElements(fragment1,
				e -> e instanceof Event || e instanceof Activity).containsAll(
				getContainedFlowElements(fragment2, n -> n instanceof Event
	...
	public static Set<FlowNode> getEventsAndActivites(Fragment fragment) {
		System.out.println(getContainedFlowElements(fragment,
				e -> e instanceof Event || e instanceof Activity));
		return getContainedFlowElements(fragment,
				e -> e instanceof Event || e instanceof Activity).stream()
				.map(e -> (FlowNode) e).collect(Collectors.toSet());

	}

	public static Set<FlowElement> getContainedFlowElements(Fragment fragment,
