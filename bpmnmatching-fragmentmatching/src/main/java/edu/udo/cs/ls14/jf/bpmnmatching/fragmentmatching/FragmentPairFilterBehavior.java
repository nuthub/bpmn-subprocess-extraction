...
/**
 * Removes all behavioral non-equivalent FragmentPairs from a FragmentMatching.
 * 
 * @author Julian Flake
 *
 */
public class FragmentPairFilterBehavior {
	...
	/**
	 * Remove behavioral non-equivalent fragment pairs from a given
	 * FragmentMatching by meanhs of a given node matching and given analysis
	 * results.
	 * 
	 ...
	 *            given FragmentMatching
	 * @param analysis1
	 *            Analysis Results of first process model
	 * @param analysis2
	 *            Analysis Results of second process model
	 * @return the fragmentmatching without behavioral inequivalent pairs
	 */
