...
/**
 * Join sequences of matched FragmentPairs.
 * 
 * @author Julian Flake
 *
 */
public class FragmentPairJointerSequential {
	...
	/**
	 * Join fragments of two FragmentPairs if they are pairwise in sequence.
	 * 
	 * @param matchingIn
	 *            FragmentMatching to check
	 * @return modified FragmentMatching
	 */
