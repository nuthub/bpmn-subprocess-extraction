 ...
 * 
 * For Details see: Richard Johnson, David Pearson und Keshav Pingali. Finding
 * Regions Fast: Single Entry Single Exit and Control Regions in Linear Time,
 * 1994.
 * 
 * Documentation is partly taken from that paper.
 * 
 * @author Julian Flake
 *
 */
public class PSTBuilder {
	 ...
	 * 
	 * @param classes
	 *            classes of cycle equivalent edges
	 * @return canonical SESE fragments
	 */
	 ...
	 * 
	 * @param start
	 *            start node of control flow graph
	 * @param end
	 *            end node of control flow graph
	 */
	 ...
	 * @return a process structure tree
	 */
	 ...
	 * 
	 * @return inserted SequenceFlow object
	 */
	 ...
	 * 
	 * @param insertEdge
	 *            inserted SequenceFlow object to remove
	 * 
	 */
	 ...
	 * @param y
	 * 
	 * @return private boolean postDominates(FlowNode end, SequenceFlow x,
	 * SequenceFlow
	 * 
	 * y) { for (SequenceFlow to : end.getIncoming()) { Set<List<SequenceFlow>>
	 * paths = getPaths(y, to, new ArrayList<SequenceFlow>()); for
	 * (List<SequenceFlow> path : paths) { if (!path.contains(x)) { return
	 * false; } } } return true; }
	 */

	/**
	 * Returns all paths between from SequenceFlow 'from' to SequenceFlow 'to'.
	 * 
	 * @param from
	 *            first SequenceFlow
	 * @param to
	 *            second SequenceFlow
	 * @param path
	 * @return Set of Paths, a path is a list of visited SequenceFlows.
	 */
	...
	/**
	 * Returns a DOT representation of the undirected graph.
	 * 
	 * TODO: remove par and margin
	 * 
	 * @param fontsize
	 *            font size of nodes and edges
	 * @return DOT String
	 */
	...
	/**
	 * Returns a DOT representation of the spanning tree.
	 * 
	 * TODO: remove par and margin
	 * 
	 * @param fontsize
	...
	/**
	 * Returns a TEX snippet of canonical fragments
	 * 
	 * @return TEX snippet
	 */
	...
	/**
	 * Returns a TEX snippet of sorted cycle equivalent edge classes
	 * 
	 * @return TEX snippet
	 */
	...
	/**
	 * Returns a TEX snippet of unsorted cycle equivalent edge classes
	 * 
	 * @return TEX snippet
	 */
