...
/**
 * Rank Fragments by the number of their elements.
 * 
 * @author Julian Flake
 *
 */
public class FragmentPairRanker {
	...
	/**
	 * Set the better fragment of each pair in given FragmentMatching. Better
	 * fragment is the fragment with less flow nodes.
	 * 
	 * @param matching
	 *            given FragmentMatching
	 * @return FragmentMatching with better property set in each fragmentpair of
	 *         the matching
	 */
	...
	/**
	 * Set the better fragment of each pair in given FragmentMatching. Better
	 * fragment is the fragment with lower control flow complexity.
	 * 
	 * @param matching
	 *            given FragmentMatching
	 * @return FragmentMatching with better property set in each fragmentpair of
