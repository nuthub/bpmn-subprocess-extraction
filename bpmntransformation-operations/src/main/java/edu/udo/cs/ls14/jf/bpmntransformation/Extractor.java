...
/**
 * Extracts fragments from a process model.
 * 
 * @author Julian Flake
 *
 */
public class Extractor {
	...
	/**
	 * Do the extraction with information of a given process transformation
	 * object.
	 * 
	 * @param transformation
	 *            given process transformation object with contained process
	 *            matching
	 * @return Transformation object with added results.
	 * @throws Exception
	 *             if an error occurs
	 */
